...
const DADOS_DO_PROJETO = {
  ...
  objetivos: {
    ...
    especificos: [
      ...
      "Investigar como as plataformas digitais e as redes sociais ampliaram as possibilidades de apostas, incluindo situações inusitadas, como previsões sobre acontecimentos mundiais ou até eventos do dia a dia.",
